classdef DetectedDir3 < DetectedDir
    ...
    methods
        %%
        function obj = DetectedDir3(tpi,overlapSizes,detectBgThreshold)
        ...
        function peakThresh_ = setPeakThresh(obj)
            peakThresh_ = 1;
            while obj.getFrameNum(obj.tpi,peakThresh_) > 3
                peakThresh_ = peakThresh_ + 1;
                if peakThresh_ >= 12
                    errordlg('Please check tpi.');
                    error('Please check tpi.');
                end
            end
            obj.peakThresh = peakThresh_;
        end
        ...
        function getDetectedDir(obj,im)
            ...
            if obj.dir_detected
                ...
                % 0
                if obj.getFrameNum(im,obj.peakThresh) > 3 % fake 0
                    obj.dir_detected = 16;
                end
            end
        end
