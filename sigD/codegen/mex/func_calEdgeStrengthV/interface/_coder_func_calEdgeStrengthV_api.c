 ...
 *
 * Code generation for function '_coder_func_calEdgeStrengthV_api'
 *
 */
...
static emlrtRTEInfo d_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_func_calEdgeStrengthV_api",  /* fName */
  ""                                   /* pName */
};
...
void func_calEdgeStrengthV_api(const mxArray * const prhs[2], const mxArray
  *plhs[1])
{
  ...
  emxInit_real_T(&st, &ev, 2, &d_emlrtRTEI, true);
  ...
  func_calEdgeStrengthV(&st, im, d, ev);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(ev);
  ev->canFreeData = false;
  emxFree_real_T(&ev);
...
/* End of code generation (_coder_func_calEdgeStrengthV_api.c) */
