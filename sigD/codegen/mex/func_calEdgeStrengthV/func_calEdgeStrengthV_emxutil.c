 ...
 *
 * Code generation for function 'func_calEdgeStrengthV_emxutil'
 *
 */
  ...
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    if (emxArray->data != NULL) {
      memcpy(newData, (void *)emxArray->data, sizeof(uint16_T) * oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex((void *)emxArray->data);
      }
    }
...
void emxEnsureCapacity_uint16_T1(const emlrtStack *sp, emxArray_uint16_T
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
...
void emxInit_uint16_T1(const emlrtStack *sp, emxArray_uint16_T **pEmxArray,
...
/* End of code generation (func_calEdgeStrengthV_emxutil.c) */
