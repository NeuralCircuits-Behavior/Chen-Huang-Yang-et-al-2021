/*
 * func_calEdgeStrengthV_types.h
 *
 * Code generation for function 'func_calEdgeStrengthV'
 *
 */

#ifndef FUNC_CALEDGESTRENGTHV_TYPES_H
#define FUNC_CALEDGESTRENGTHV_TYPES_H
...
/* End of code generation (func_calEdgeStrengthV_types.h) */
