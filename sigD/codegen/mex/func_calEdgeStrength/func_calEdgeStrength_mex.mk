MATLAB_ROOT = E:\Prog\MATLAB\2018b
MAKEFILE = func_calEdgeStrength_mex.mk

include func_calEdgeStrength_mex.mki


SRC_FILES =  \
	func_calEdgeStrength_data.c \
	...
	func_calEdgeStrength_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = func_calEdgeStrength_mex
...
SYS_INCLUDE += -I"E:\X\sigD\codegen\mex\func_calEdgeStrength"
SYS_INCLUDE += -I"E:\X\sigD"
...
%.$(OBJEXT) : E:\X\sigD\codegen\mex\func_calEdgeStrength/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
